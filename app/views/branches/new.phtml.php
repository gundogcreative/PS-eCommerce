    ...
    <?php echo $this->assets->outputJs(); ?>
        ...
        <div class="pageContent">
            ...
            <div class="content">
                ...
                <h3>Create</h3>
                <?php echo $this->tag->form(array('branches/create', 'method' => 'post')); ?>
                <div class="flashSession errorSession"><?php $this->flashSession->output() ?></div>
                <div class="row">
                    <div class="small-4 columns">
                        <label>Branch Name<small>required</small>
                        <?php echo $this->tag->textField(array("branchName", "size" => "30", "maxlength" => 30)) ?>
                    </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="small-4 columns">
                        ...
                        <?php echo $this->tag->textField(array("abbreviation", "size" => "10",  "maxlength" => 10)) ?>
                    </label>
                    </div>
                </div>
